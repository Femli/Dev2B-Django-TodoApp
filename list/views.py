...
def services(request):
    first = "Franky"
    last = "Tanky"
    top_four = ["Pokemon", "God of War", "League of Legends", "Spyro"]
    context = {'first_name':first, 'last_name':last, 'top_four_games':top_four} #We need to store the variables we want to pass into a dictionary, it's the only way DTL can render it
